...
func TestGetSimplePackage(t *testing.T) {
	packages := getPackages("openssh-server 1.2.3\n")

	version := packages["openssh-server"].(string)
	if version != "1.2.3" {
		t.Errorf("Version not correctly processed")
	}
}
...
// alsa-ucm-conf:1.2.10-1ubuntu5.4
...
// apport-core-dump-handler:2.28.1-0ubuntu3.5
// apport-gtk:2.28.1-0ubuntu3.5
...
// cloud-init:24.4.1-0ubuntu0~24.04.1
...
// cuda-nvprune-12-6:12.6.77-1
// cuda-nvrtc-12-6:12.6.85-1
...
// cuda-toolkit-12-6-config-common:12.6.77-1
...
// distro-info-data:0.60ubuntu0.2
...
// docker-ce-rootless-extras:5:28.0.2-1~ubuntu.24.04~noble
...
// evolution-data-server:3.52.3-0ubuntu1
...
// gir1.2-gtk-4.0:4.14.2+ds-1ubuntu1
// gir1.2-gweather-4.0:4.4.2-1build1
// gir1.2-handy-1:1.8.3-1build2
// gir1.2-harfbuzz-0.0:8.3.0-2build2
// gir1.2-ibus-1.0:1.5.29-2
// gir1.2-javascriptcoregtk-4.1:2.46.6-0ubuntu0.24.04.1
// gir1.2-javascriptcoregtk-6.0:2.46.6-0ubuntu0.24.04.1
// gir1.2-mutter-14:46.2-1ubuntu0.24.04.6
// gir1.2-nm-1.0:1.46.0-1ubuntu2.2
// gir1.2-nma4-1.0:1.10.6-3build2
// gir1.2-notify-0.7:0.8.3-1build2
...
// gir1.2-snapd-2:1.64-0ubuntu5
// gir1.2-soup-3.0:3.4.4-5ubuntu0.1
// gir1.2-upowerglib-1.0:1.90.3-1
// gir1.2-vte-2.91:0.76.0-1ubuntu0.1
// gir1.2-webkit-6.0:2.46.6-0ubuntu0.24.04.1
// gir1.2-webkit2-4.1:2.46.6-0ubuntu0.24.04.1
...
// gnome-calculator:1:46.1-1ubuntu1~24.04.1
// gnome-characters:46.0-1build1
// gnome-clocks:46.0-1build1
// gnome-control-center:1:46.5-0ubuntu0.24.04.1
// gnome-control-center-data:1:46.5-0ubuntu0.24.04.1
// gnome-control-center-faces:1:46.5-0ubuntu0.24.04.1
// gnome-desktop3-data:44.0-5build2
// gnome-disk-utility:46.0-1ubuntu3
// gnome-font-viewer:46.0-1build1
// gnome-initial-setup:46.3-1ubuntu3~24.04.1
...
// gnome-shell:46.0-0ubuntu6~24.04.6
// gnome-shell-common:46.0-0ubuntu6~24.04.6
// gnome-shell-extension-appindicator:58-1ubuntu24.04.1
// gnome-shell-extension-desktop-icons-ng:46+really47.0.9-1ubuntu1
// gnome-shell-extension-ubuntu-dock:90ubuntu2
...
// grub-common:2.12-1ubuntu7.1
// grub-efi-amd64:2.12-1ubuntu7.1
// grub-efi-amd64-bin:2.12-1ubuntu7.1
// grub-efi-amd64-signed:1.202.2+2.12-1ubuntu7.1
// grub-gfxpayload-lists:0.7build2
// grub-pc:2.12-1ubuntu7.1
// grub-pc-bin:2.12-1ubuntu7.1
// grub2-common:2.12-1ubuntu7.1
...
// ibus-gtk4:1.5.29-2
// ibus-table:1.17.4-2
// ibus-table-cangjie-big:1.8.12-1
// ibus-table-cangjie3:1.8.12-1
// ibus-table-cangjie5:1.8.12-1
...
// libapparmor1:4.0.1really4.0.1-0ubuntu0.24.04.3
...
// libchewing3:0.6.0-1build1
// libchewing3-data:0.6.0-1build1
...
// libctf-nobfd0:2.42-4ubuntu2.4
// libctf0:2.42-4ubuntu2.4
...
// libdebuginfod-common:0.190-1.1build4.1
// libdebuginfod1t64:0.190-1.1build4.1
// libdecor-0-0:0.2.2-1build2
// libdecor-0-plugin-1-gtk:0.2.2-1build2
...
// libdw1t64:0.190-1.1build4.1
// libeatmydata1:131-1ubuntu1
// libebackend-1.2-11t64:3.52.3-0ubuntu1
// libebook-1.2-21t64:3.52.3-0ubuntu1
// libebook-contacts-1.2-4t64:3.52.3-0ubuntu1
// libecal-2.0-3:3.52.3-0ubuntu1
// libedata-book-1.2-27t64:3.52.3-0ubuntu1
// libedata-cal-2.0-2t64:3.52.3-0ubuntu1
// libedataserver-1.2-27t64:3.52.3-0ubuntu1
// libedataserverui-1.2-4t64:3.52.3-0ubuntu1
...
// libfprint-2-2:1:1.94.7+tod1-0ubuntu5~24.04.2
// libfprint-2-tod1:1:1.94.7+tod1-0ubuntu5~24.04.2
...
// libfwupd2:1.9.28-0ubuntu1~24.04.1
// libgail-common:2.24.33-4ubuntu1.1
// libgail18t64:2.24.33-4ubuntu1.1
// libgamemode0:1.8.1-2build1
// libgamemodeauto0:1.8.1-2build1
...
// libgnomekbd-common:3.28.1-1build3
// libgnomekbd8:3.28.1-1build3
...
// libgphoto2-l10n:2.5.31-2.1build2
// libgphoto2-port12t64:2.5.31-2.1build2
// libgpm2:1.20.7-11
// libgprofng0:2.42-4ubuntu2.4
...
// libgtk-3-bin:3.24.41-4ubuntu1.2
// libgtk-3-common:3.24.41-4ubuntu1.2
// libgtk-4-1:4.14.2+ds-1ubuntu1
// libgtk-4-bin:4.14.2+ds-1ubuntu1
// libgtk-4-common:4.14.2+ds-1ubuntu1
// libgtk-4-media-gstreamer:4.14.2+ds-1ubuntu1
// libgtk2.0-0t64:2.24.33-4ubuntu1.1
// libgtk2.0-bin:2.24.33-4ubuntu1.1
...
// libgumbo2:0.12.0+dfsg-2build1
// libgupnp-1.6-0:1.6.6-1build3
// libgupnp-av-1.0-3:0.14.1-2build2
// libgupnp-dlna-2.0-4:0.12.0-4build2
...
// libipa-hbac0t64:2.9.4-1.1ubuntu6.2
...
// libmujs3:1.3.3-3build2
// libmutter-14-0:46.2-1ubuntu0.24.04.6
...
// libnetplan1:1.1.1-1~ubuntu24.04.1
...
// libnvidia-cfg1-550:550.144.03-0ubuntu1
...
// libnvidia-extra-550:550.144.03-0ubuntu1
...
// libpcre2-32-0:10.42-4ubuntu2.1
// libpcre2-8-0:10.42-4ubuntu2.1
// libpcsclite1:2.0.3-1build1
// libpeas-1.0-0:1.36.0-3build4
// libpeas-common:1.36.0-3build4
// libperl5.38t64:5.38.2-3.2build2.1
// libphonenumber8:8.12.57+ds-4.2build3
// libpinyin-data:2.8.1-1build3
// libpinyin15:2.8.1-1build3
// libpipeline1:1.5.7-2
// libpipewire-0.3-0t64:1.0.5-1ubuntu3
// libpipewire-0.3-common:1.0.5-1ubuntu3
...
// libpoppler-cpp0t64:24.02.0-1ubuntu9.2
// libpoppler-glib8t64:24.02.0-1ubuntu9.2
...
// libprotobuf32t64:3.21.12-8.2build1
// libproxy1-plugin-gsettings:0.5.4-4build1
// libproxy1-plugin-networkmanager:0.5.4-4build1
...
// libpython3-dev:3.12.3-0ubuntu2
// libpython3-stdlib:3.12.3-0ubuntu2
// libpython3.12-dev:3.12.3-1ubuntu0.5
...
// librygel-core-2.8-0:0.42.5-1ubuntu3
// librygel-db-2.8-0:0.42.5-1ubuntu3
// librygel-renderer-2.8-0:0.42.5-1ubuntu3
// librygel-server-2.8-0:0.42.5-1ubuntu3
// libsamplerate0:0.2.2-4build1
// libsane-common:1.2.1-7build4
// libsane-hpaio:3.23.12+dfsg0-0ubuntu5
...
// libsoup-3.0-common:3.4.4-5ubuntu0.1
// libsoup2.4-common:2.74.3-6ubuntu1.1
...
// libsss-certmap0:2.9.4-1.1ubuntu6.2
// libsss-idmap0:2.9.4-1.1ubuntu6.2
// libsss-nss-idmap0:2.9.4-1.1ubuntu6.2
...
// libsysmetrics1:1.7.3ubuntu0.24.04.2
...
// libwmflite-0.2-7:0.2.13-1.1build3
...
// libxcb-xinput0:1.15-1ubuntu2
// libxcb-xkb1:1.15-1ubuntu2
// libxcb-xv0:1.15-1ubuntu2
...
// libxnvctrl0:570.124.06-0ubuntu1
...
// linux-generic-hwe-24.04:6.11.0-19.19~24.04.1
// linux-headers-6.11.0-19-generic:6.11.0-19.19~24.04.1
// linux-headers-generic-hwe-24.04:6.11.0-19.19~24.04.1
// linux-hwe-6.11-headers-6.11.0-19:6.11.0-19.19~24.04.1
// linux-hwe-6.11-tools-6.11.0-19:6.11.0-19.19~24.04.1
// linux-image-6.11.0-19-generic:6.11.0-19.19~24.04.1
// linux-image-generic-hwe-24.04:6.11.0-19.19~24.04.1
// linux-libc-dev:6.8.0-55.57
// linux-modules-6.11.0-19-generic:6.11.0-19.19~24.04.1
// linux-modules-extra-6.11.0-19-generic:6.11.0-19.19~24.04.1
// linux-modules-nvidia-550-6.11.0-19-generic:6.11.0-19.19~24.04.1+1
// linux-modules-nvidia-550-generic-hwe-24.04:6.11.0-19.19~24.04.1+1
// linux-objects-nvidia-550-6.11.0-19-generic:6.11.0-19.19~24.04.1+1
// linux-signatures-nvidia-6.11.0-19-generic:6.11.0-19.19~24.04.1+1
// linux-sound-base:1.0.25+dfsg-0ubuntu7
// linux-tools-6.11.0-19-generic:6.11.0-19.19~24.04.1
// linux-tools-common:6.8.0-55.57
// lmodern:2.005-1
...
// media-types:10.1.0
// memtest86+:7.00-1build1
// mesa-libgallium:24.2.8-1ubuntu1~24.04.1
// mesa-vdpau-drivers:24.2.8-1ubuntu1~24.04.1mesa-vulkan-drivers:24.2.8-1ubuntu1~24.04.1
...
// netplan-generator:1.1.1-1~ubuntu24.04.1
// netplan.io:1.1.1-1~ubuntu24.04.1
// network-manager:1.46.0-1ubuntu2.2
// network-manager-config-connectivity-ubuntu:1.46.0-1ubuntu2.2
// network-manager-gnome:1.34.0-1ubuntu3
...
// nvidia-compute-utils-550:550.144.03-0ubuntu1
// nvidia-dkms-550:550.144.03-0ubuntu1
// nvidia-driver-550:550.144.03-0ubuntu1
// nvidia-firmware-550-550.120:550.120-0ubuntu0.24.04.1
// nvidia-firmware-550-550.144.03:550.144.03-0ubuntu1
// nvidia-kernel-common-550:550.144.03-0ubuntu1
// nvidia-kernel-source-550:550.144.03-0ubuntu1
// nvidia-prime:0.8.17.2
// nvidia-settings:570.124.06-0ubuntu1
...
// openssh-sftp-server:1:9.6p1-3ubuntu13.8
...
// python3-distupgrade:1:24.04.26
...
// python3-netplan:1.1.1-1~ubuntu24.04.1
...
// python3-software-properties:0.99.49.1
// python3-speechd:0.12.0~rc2-2build3
// python3-sss:2.9.4-1.1ubuntu6.2
// python3-systemd:235-1build4
// python3-typing-extensions:4.10.0-1
// python3-tz:2024.1-2
// python3-update-manager:1:24.04.9
...
// software-properties-gtk:0.99.49.1
// sound-icons:0.1-8
...
// sssd-ad:2.9.4-1.1ubuntu6.2
// sssd-ad-common:2.9.4-1.1ubuntu6.2
// sssd-common:2.9.4-1.1ubuntu6.2
// sssd-ipa:2.9.4-1.1ubuntu6.2
// sssd-krb5:2.9.4-1.1ubuntu6.2
// sssd-krb5-common:2.9.4-1.1ubuntu6.2
// sssd-ldap:2.9.4-1.1ubuntu6.2
// sssd-proxy:2.9.4-1.1ubuntu6.2
// strace:6.8-0ubuntu2
// sudo:1.9.15p5-3ubuntu5
// switcheroo-control:2.6-2build2
// sysstat:12.6.1-2
// system-config-printer-common:1.5.18-1ubuntu9
// system-config-printer-udev:1.5.18-1ubuntu9
// systemd:255.4-1ubuntu8.6
// systemd-dev:255.4-1ubuntu8.6
// systemd-hwe-hwdb:255.1.4
// systemd-oomd:255.4-1ubuntu8.6
...
// ubuntu-release-upgrader-core:1:24.04.26
// ubuntu-release-upgrader-gtk:1:24.04.26
// ubuntu-report:1.7.3ubuntu0.24.04.2
// ubuntu-session:46.0-1ubuntu4
// ubuntu-settings:24.04.5
...
// update-notifier:3.192.68build3
...
// xdg-user-dirs-gtk:0.11-1build2
...
// xserver-common:2:21.1.12-1ubuntu1.2
// xserver-xephyr:2:21.1.12-1ubuntu1.2
// xserver-xorg:1:7.7+23ubuntu3
// xserver-xorg-core:2:21.1.12-1ubuntu1.2
// xserver-xorg-input-all:1:7.7+23ubuntu3
// xserver-xorg-input-libinput:1.4.0-1build1
// xserver-xorg-input-wacom:1:1.2.0-1ubuntu2
// xserver-xorg-legacy:2:21.1.12-1ubuntu1.2
...
// xserver-xorg-video-nvidia-550:550.144.03-0ubuntu1
...
// yaru-theme-gtk:24.04.2-0ubuntu1
// yaru-theme-icon:24.04.2-0ubuntu1
